...
ARG NEXT_PUBLIC_ADSENSE_NEWS_LEADERBOARD_SLOT=""
ARG NEXT_PUBLIC_ADSENSE_NEWS_RECTANGLE_SLOT=""
ARG NEXT_PUBLIC_ADSENSE_NEWS_SQUARE_SLOT=""
ARG NEXT_PUBLIC_ADSENSE_NEWS_IN_ARTICLE_SLOT=""
...
ENV NEXT_PUBLIC_API_BASE=__RT_API_BASE__ \
    ...
    NEXT_PUBLIC_ADSENSE_NEWS_LEADERBOARD_SLOT=${NEXT_PUBLIC_ADSENSE_NEWS_LEADERBOARD_SLOT} \
    NEXT_PUBLIC_ADSENSE_NEWS_RECTANGLE_SLOT=${NEXT_PUBLIC_ADSENSE_NEWS_RECTANGLE_SLOT} \
    NEXT_PUBLIC_ADSENSE_NEWS_SQUARE_SLOT=${NEXT_PUBLIC_ADSENSE_NEWS_SQUARE_SLOT} \
    NEXT_PUBLIC_ADSENSE_NEWS_IN_ARTICLE_SLOT=${NEXT_PUBLIC_ADSENSE_NEWS_IN_ARTICLE_SLOT} \
